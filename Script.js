    ...
    return function (t, e, n) {
        function i() {
            var t = h.scrollElement.innerWidth,
                ...
                s = h.bindElement.scrollLeft ? h.bindElement.scrollLeft : document.documentElement.scrollLeft;
            if (a.left != s || a.top != n) {
                for (var f = 0; f < o.length; f++) {
                    var u = o[f],
                        m = u.left(),
                        g = u.top();
                    a.left > s ? m -= u.xOffset(!0) : a.left < s && (m += u.xOffset(!1)), a.top > n ? g -= u.yOffset(!0) : a.top < n && (g += u.yOffset(!1)), t > m && m >= 0 && e > g && g >= 0 ? (u.addClass(u.visibleClass, function () {
                        u.showCallback && l(u, u.showCallback)
                    }), u.removeClass(u.hiddenClass), u.once && o.splice(f, 1)) : (u.addClass(u.hiddenClass), u.removeClass(u.visibleClass, function () {
        ...
        var s = function (t, e) {
            ...
            this.left = function (t) {
                ...
                return function () {
                    ...
                    e ? (e.toggle && e.toggle.visible && (t.visibleClass = e.toggle.visible), e.toggle && e.toggle.hidden && (t.hiddenClass = e.toggle.hidden), e.centerHorizontal === !0 && (n = t.element.offsetWidth / 2), e.centerVertical === !0 && (i = t.element.offsetHeight / 2), e.offset && e.offset.x && (n += e.offset.x), e.offset && e.offset.y && (i += e.offset.y), e.addWidth && (t.addWidth = e.addWidth), e.addHeight && (t.addHeight = e.addHeight), e.once && (t.once = e.once)) : (t.addWidth = l.indexOf("addWidth") > -1, t.addHeight = l.indexOf("addHeight") > -1, t.once = l.indexOf("once") > -1), t.showCallback = t.element.getAttribute("data-scroll-showCallback"), t.hideCallback = t.element.getAttribute("data-scroll-hideCallback");
                    var s = l.split("toggle(");
                    if (s.length > 1) {
                        var o = s[1].split(")")[0].split(",");
                        String.prototype.trim || (String.prototype.trim = function () {
                            return this.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")
                        }), t.visibleClass = o[0].trim().replace(".", ""), t.hiddenClass = o[1].trim().replace(".", "")
                    }
                    ...
                    if (r.length > 1) {
                        ...
                        n += parseInt(a[0].replace("px", "")), i += parseInt(a[1].replace("px", ""))
                    }
                    return t
                }
            }(this)
        ...
        var o = [],
            ...
            f = function (t) {
                return function (e, n, l) {
                    return void 0 != n && null != n ? t.bindElement = n : t.bindElement = document.body, void 0 != l && null != l ? t.scrollElement = l : t.scrollElement = window, o = [].slice.call(t.bindElement.querySelectorAll("[data-scroll]")), o = o.map(function (t) {
                        var n = new s(e, t);
                        return n.init()
                    }), o.length > 0 ? (c = !0, i()) : c = !1, t
                }
            }(this);
